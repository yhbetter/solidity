...
(function($){
    ...
    $.fn.tagEditor = function(options, val, next){
        ...
        if (typeof options == 'string') {
            ...
            selector.each(function(){
                ...
                if (options == 'getTags')
                    ...
                    $('<li><div class="tag-editor-spacer">&nbsp;'+o.delimiter[0]+'</div><div class="tag-editor-tag"></div></li>').appendTo(ed).find('.tag-editor-tag')
                        .html('<input type="text" maxlength="'+o.maxLength+'">').addClass('active').find('input').val(val).blur();
        ...
        return selector.each(function(){
            ...
            var new_tag = '<li><div class="tag-editor-spacer">&nbsp;'+o.delimiter[0]+'</div><div class="tag-editor-tag"></div></li>';
            ...
            function split_cleanup(input){
                ...
                for (i in sub_tags) {
                    ...
                    if (tag) {
                        ...
                        li.before('<li><div class="tag-editor-spacer">&nbsp;'+o.delimiter[0]+'</div><div class="tag-editor-tag">'+tag+'</div></li>');
                    }
                }
            ...
            for (i in tags) {
                ...
                if (tag) {
                    ...
                    ed.append('<li><div class="tag-editor-spacer">&nbsp;'+o.delimiter[0]+'</div><div class="tag-editor-tag">'+tag+'</div></li>');
                }
            }
