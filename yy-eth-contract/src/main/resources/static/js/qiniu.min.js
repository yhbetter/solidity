...
!function (global) {
    ...
    function QiniuJsSDK() {
        ...
        this.detectIEVersion = function () {
            var a = 4, b = document.createElement("div"), c = b.getElementsByTagName("i");
        ...
        this.resetUploadUrl = function () {
            ...
            for (var g = 0; f > g; g++) {
                ...
                var i = null;
                if (128 > h)e++; else if (h > 127 && 2048 > h)i = String.fromCharCode(h >> 6 | 192, 63 & h | 128); else if (63488 & h ^ !0)i = String.fromCharCode(h >> 12 | 224, h >> 6 & 63 | 128, 63 & h | 128); else {
            ...
            }, that.uptoken_url = a.uptoken_url, that.token = "", that.key_handler = "function" == typeof a.init.Key ? a.init.Key : "", this.domain = a.domain;
            var h = "";
            var i = {isResumeUpload: !1, resumeFilesize: 0, startTime: "", currentTime: ""};
            ...
            logger.debug("new plupload.Uploader(option)"), j.bind("Init", function (b, d) {
                ...
                f = f || a.settings && a.settings.chunk_size, f > e && (a.setOption({url: qiniuUploadUrl + "/mkblk/" + e}), logger.debug("up.setOption url: ", qiniuUploadUrl + "/mkblk/" + e)), localStorage.setItem(b.name, that.stringifyJSON({
                    ctx: h,
                    percent: b.percent,
                    total: c.total,
                    offset: c.offset,
            ...
            var c = a["auto-orient"] || "", d = a.thumbnail || "", e = a.strip || "", f = a.gravity || "", g = a.crop || "", h = a.quality || "", i = a.rotate || "", j = a.format || "", k = a.blur || "";
            var l = "imageMogr2";
